...
namespace CursoCSharp.ClassesEMetodos
{
    interface Ponto
    {
        void MoverNaDiagonal(int delta); //Função sem corpo,  método de uma interface é public por padrão.
    }

    struct Coordenada : Ponto //Criação dos atributos 
    {
        public int X;
        public int Y;
    ...
    class ExemploStruct
    {
        public static void Executar()
        {
            ...
            Console.WriteLine("Coordenanda Final:");
